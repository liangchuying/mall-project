...
- [x] 商品分类管理
  ...
  - [x] 获取分类树（支持多级）
- [x] SPU/SKU 商品管理
  - [x] 商品 SPU 管理（创建、查询、更新、删除）
  - [x] 商品 SKU 管理（创建、查询、更新、删除）
  - [x] 商品品牌管理（创建、查询、更新、删除）
  - [x] 商品图片管理
  - [x] 商品分页查询（支持按分类、品牌、名称、状态筛选）
  - [x] 商品与 SKU、图片的关联管理
- [x] 库存管理
  - [x] 入库功能（增加库存）
  - [x] 出库功能（减少库存）
...
- [x] 支付模块
  ...
  - [x] 集成 JWT 认证
- [x] 优惠券系统
  - [x] 优惠券创建（支持三种类型：满减券、折扣券、立减券）
  - [x] 优惠券领取（生成唯一优惠券码）
  - [x] 用户优惠券管理（查询、状态跟踪）
  - [x] 优惠券折扣计算
  - [x] 优惠券过期检测
  - [x] 优惠券使用状态管理（未使用、已使用、已过期）
  - [x] 集成 JWT 认证
- [x] 全局异常处理
